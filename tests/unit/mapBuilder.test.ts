...
import { buildMap } from '../../src/runtime/mapBuilder';
...
describe('mapBuilder', () => {
  it('buildMap returns terrainMesh and obstacleMeshes', () => {
    const mapData = generateMap(defaultSceneConfig.mapConfig);
    const result = buildMap(mapData, defaultSceneConfig);
  ...
  it('buildMap with small map produces correct structure', () => {
